...
AICorp is organized as one project repository with the `aicorp-iac`, `aicorp-config`, and `aicorp-apps` project folders. These decisions provide the shared architectural baseline for the four project areas.
